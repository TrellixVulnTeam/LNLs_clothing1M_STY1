...
# MT
parser.add_argument('--consistency', default=100.0, type=float, help='use consistency loss with given weight (default: None)')
parser.add_argument('--consistency-type', default="mse", type=str, choices=['mse', 'kl'], help='consistency loss type to use')
parser.add_argument('--consistency-rampup', default=5, type=int, help='length of the consistency loss ramp-up')

# filtering
parser.add_argument('--exclude-unlabeled', default=False, type=bool, help='exclude unlabeled examples from the training set')
parser.add_argument('--batch-size', default=256, type=int, help='batch size')
parser.add_argument('--labeled-batch-size', default=62, type=int, help="labeled examples per minibatch (default: no constrain)")
