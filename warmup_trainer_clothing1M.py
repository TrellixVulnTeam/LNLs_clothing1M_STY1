...
from train_utils import lr_cosineannealing, lr_clothing1M
...
class Supervised():
    ...
    def train(self, trainloader, epoch):
        ...
        for batch_idx, (inputs1, targets,_) in enumerate(trainloader):
            
            lr_cosineannealing(self.optimizer, epoch, batch_idx, len(trainloader))
            #lr_clothing1M(self.optimizer,epoch)
...
class Filter():
    ...
    def __init__(self, trainloader, args):
        ...
        #self.clean_labels = np.array(clean_labels[0])       #clean labels from trainset 45000
        
        #self.noisy_labels = np.array(noisy_labels[0])
        #self.clean_or_not = self.clean_labels == self.noisy_labels    # 45000 - 36000
        #self.noisy_or_not = self.clean_labels != self.noisy_labels    # 36000
